            ...
            <div class="about">
                ...
                <ul class="ingredient_all">
                    <li class="ingredient_1">
                        ...
                        <p style="" class="description_ingredient"><?php echo $resultat_afficher[0]['name'] ?></p>
                    </li>
                ...
                <form method="post" action="page.php" style="margin: auto; width: 300px;display:flex;padding-left:20px;">
                    ...
                    <p style=""><input type="submit" value="Go to page" /></p>
                </form>
